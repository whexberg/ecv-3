    ...
    return (
        <PageWrapper>
            <PageSection heading="Lord Sholto Douglas" subheading="E Clampus Vitus Chapter #3" id="title">
                ...
                <p className="bg-background mx-auto max-w-xl text-center text-lg md:text-xl">
            ...
            <PageSection heading="Donations" id="donations">
            ...
            <PageSection heading="Upcoming Events" id="events">
                <div className="mx-auto mt-28 flex basis-1/2 flex-col justify-center gap-4">
                    ...
                    <div className="mx-auto mt-4 flex max-w-xl flex-col items-center gap-4 xl:gap-12">
                        ...
                        <div className="border-accent gap flex flex-wrap justify-around border p-4">
                            {[
                                ...
                                <div className="w-auto max-w-[30%]" key={link}>
                                    <Link href={link}>
